...
- 🚀 CI pipeline refactor to split the process into the following steps: Config-files, Build, Documentation, Tests and Security. By [@JMTamayo](https://github.com/JMTamayo).
